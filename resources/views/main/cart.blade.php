                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            ...
                            @if (empty($currentBasket))
                                <p class="info">Your basket is empty!</p>
                            @else
                                <table class="table shopping-summery text-center clean">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($products as $product)
                                            {{ $total += $product->price * $currentBasket[$product->id] }} <tr>
                                                <td class="image product-thumbnail"><img
                                                        src="assets/imgs/shop/product-1-2.jpg" alt="#"></td>
                                                <td class="product-des product-name">
                                                    <h5 class="product-name"><a
                                                            href="product-details.html">{{ $product->libelle }}</a></h5>
                                                ...
                                                <td class="text-center" data-title="Stock">
                                                    <div class="detail-qty border radius  m-auto">
                                                        ...
                                                        <span class="qty-val">{{ $currentBasket[$product->id] }}</span>
                                                        <a href="#" class="qty-up"><i
                                                                class="fi-rs-angle-small-up"></i></a>
                                                    </div>
                                                </td>
                                                <td class="text-right" data-title="Cart">
                                                    <span>{{ $product->price * $currentBasket[$product->id] }} </span>
                                                </td>

                                                <td class="action" data-title="Remove"><a
                                                        href="{{ route('remove_form_session', ['productId' => $product->id]) }}"
                                        ...
                                        <tr>
                                            <td class="image product-thumbnail"><img
                                                    src="assets/imgs/shop/product-1-2.jpg" alt="#"></td>
                                            <td class="product-des product-name">
                                                <h5 class="product-name"><a href="product-details.html">J.Crew
                                                        Mercantile Women's Short-Sleeve</a></h5>
                                                <p class="font-xs">Maboriosam in a tonto nesciung eget<br> distingy
                                                    magndapibus.
                                                </p>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="image"><img src="assets/imgs/shop/product-6-1.jpg"
                                                    alt="#"></td>
                                            <td class="product-des">
                                                <h5 class="product-name"><a href="product-details.html">Amazon Brand -
                                                        Daily Ritual Women's Jersey </a></h5>
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-end">
                                                <a href="{{ route('clearCart') }}" class="text-muted"> <i
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><span
                                                            class="font-lg fw-900 text-brand">${{ $total }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
