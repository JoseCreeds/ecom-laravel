                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                        ...
                                        <div class="product-cart-wrap mb-30">
                                            <div class="product-img-action-wrap">
                                                ...
                                                <div class="product-action-1">
                                                    <a aria-label="Quick view" class="action-btn hover-up"
                                                        ...
                                                        href="assets/imgs/shop/product-1-2.jpg"><i
                                                            class="fi-rs-eye"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <h2><a
                                                        href="{{ route('product-details') }}">{{ $product->libelle }}</a>
                                                </h2>
                                                ...
                                                <div class="product-action-1 show">
                                                    <a aria-label="Add To Cart" class="action-btn hover-up"
                                                        href="{{route('basket', ['id'=>$product->id])}}"><i class="fi-rs-shopping-bag-add"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container pt-25">
                <div class="row mb-50">
                    <div class="col-lg-12 col-md-12 text-center">
                        ...
                        <h2 class="mb-15 text-grey-1 wow fadeIn animated">Take a look what<br> our clients say about
                            us</h2>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                            ...
                            <div class="pl-30">
                                ...
                                <p class="text-grey-3">"Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    Debitis nesciunt voluptatum dicta reprehenderit accusamus voluptatibus voluptas."
                                </p>
                            </div>
                        </div>
                    </div>
