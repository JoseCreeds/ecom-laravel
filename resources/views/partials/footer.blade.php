<footer class="main">
                ...
                <div class="col-lg-7 mb-md-3 mb-lg-0">
                    <div class="row align-items-center">
                        <div class="col flex-horizontal-center">
                            ...
                            <h4 class="font-size-20 mb-0 ml-3">Join Our VIP List!</h4>
                        </div>
                        <div class="col my-4 my-md-0 des">
                            <h5 class="font-size-15 ml-4 mb-0">Promotions, New products and Giveaways. Directly to your inbox.</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
    ...
    <section class="section-padding footer-mid">
        <div class="container pt-15 pb-20">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-3">
                    <h5 class="widget-title wow fadeIn animated">Store Policy</h5>
                    <ul class="footer-list wow fadeIn animated mb-sm-5 mb-md-0">
    ...
    <div class="container pb-20 wow fadeIn animated mob-center" >
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-0 col-lg-3 mt-md-3 mt-lg-0" ></div>
                ...
                <div class="footer__content-bottom-wrapper page-width">
                    ...
                    <div class="footer__column footer__column--info">
                        <div class="footer__payment">
                            ...
                            <ul class="list list-payment" role="list" style="display: flex; align-item: center">
                                <li class="list-payment__item" style="margin: auto">
                                ...
                                {{-- <li class="list-payment__item" style="margin: auto">
                                    <svg class="icon icon--full-color" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        role="img" x="0" y="0" width="38" height="24"
                                        viewBox="0 0 165.521 105.965" xml:space="preserve"
                                ...
                                {{-- <li class="list-payment__item" style="margin: auto">
                                    <svg class="icon icon--full-color" width="38" height="24" role="img"
                                        ...
                                        <path
                                            ...
                                            fill="#000000"></path>
                                        <defs>
                                            <linearGradient id="pi-paint0_linear_1164_3" x1="5.93"
                                                y1="12.703" x2="12.196" y2="13.019"
                                            ...
                                            <linearGradient id="pi-paint1_linear_1164_3" x1="5.424"
                                                y1="13.399" x2="5.424" y2="11.089"
                                                gradientUnits="userSpaceOnUse">
                                ...
                                {{-- <li class="list-payment__item" style="margin: auto">
                                    <svg class="icon icon--full-color" viewBox="0 0 38 24" width="38"
                                        height="24" xmlns="http://www.w3.org/2000/svg" role="img"
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <p class="float-md-left font-sm text-muted mb-0">
                    &copy; <strong class="text-brand">2023</strong> Ecom
